(function ($) {
	...
	$('.header-area .main-nav .nav li.has-sub > a').on('click', function(e) {
		if ($(window).width() <= 767) {
			...
			$('.header-area .main-nav .nav li.has-sub').not($parent).removeClass('is-open-sub').find('.sub-menu').slideUp(200);
	...
	$('.header-area .main-nav .nav li.has-sub').hover(
		function() {
			if ($(window).width() > 767) {
	...
	$(document).on('click', function(e) {
		if (!$(e.target).closest('.header-area').length) {
			if ($('.menu-trigger').hasClass('active')) {
				...
				$('.header-area .main-nav .nav li.has-sub').removeClass('is-open-sub').find('.sub-menu').slideUp(200);
			}
		}
	});
	...
	$(window).resize(function() {
		if ($(window).width() > 767) {
			...
			$('.menu-trigger').removeClass('active');
			$('.header-area .main-nav .nav li.has-sub').removeClass('is-open-sub').find('.sub-menu').hide();
		} else {
			if (!$('.menu-trigger').hasClass('active')) {
